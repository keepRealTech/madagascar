...
import com.keepreal.madagascar.workflow.reconciliation.repository.WorkflowRepository;
...
public class WorkflowService {
    ...
    private static final String WORKFLOW_TYPE = "reconciliation-daily";
    ...
    public void failed(WorkflowLog workflowLog, Throwable throwable) {
        this.failed(workflowLog, throwable.getMessage());
    }
