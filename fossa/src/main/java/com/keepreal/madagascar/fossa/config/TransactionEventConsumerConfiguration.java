...
import com.keepreal.madagascar.fossa.consumer.TransactionEventListener;
import lombok.Data;
...
/**
 * Represents the transaction message consumer configurations.
 */
@Configuration
@ConfigurationProperties(prefix = "rocketmq.transaction")
@Data
public class TransactionEventConsumerConfiguration {
     ...
     */
    @Bean(name = "transaction-event-consumer", initMethod = "start", destroyMethod = "shutdown")
    public ConsumerBean buildConsumer() {
        ...
        subscriptionTable.put(subscription, this.transactionEventListener);
