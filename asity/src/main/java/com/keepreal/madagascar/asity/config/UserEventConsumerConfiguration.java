...
import com.keepreal.madagascar.asity.consumer.UserEventListener;
import lombok.Data;
 ...
 */
@Configuration
@ConfigurationProperties(prefix = "rocketmq.user", ignoreUnknownFields = false)
@Data
public class UserEventConsumerConfiguration {
     ...
     */
    @Bean(name = "user-event-consumer", initMethod = "start", destroyMethod = "shutdown")
    public ConsumerBean buildConsumer() {
        ...
        subscriptionTable.put(subscription, this.userEventListener);
